...
[![GitHub stars](https://img.shields.io/github/stars/SxunS/nas-tools?style=plastic)](https://github.com/SxunS/nas-tools/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/SxunS/nas-tools?style=plastic)](https://github.com/SxunS/nas-tools/network/members)
[![GitHub issues](https://img.shields.io/github/issues/SxunS/nas-tools?style=plastic)](https://github.com/SxunS/nas-tools/issues)
[![GitHub license](https://img.shields.io/github/license/SxunS/nas-tools?style=plastic)](https://github.com/SxunS/nas-tools/blob/master/LICENSE.md)
[![Docker pulls](https://img.shields.io/docker/pulls/SxunS/nas-tools?style=plastic)](https://hub.docker.com/r/SxunS/nas-tools)
[![Platform](https://img.shields.io/badge/platform-amd64/arm64-pink?style=plastic)](https://hub.docker.com/r/SxunS/nas-tools)


Docker：https://hub.docker.com/repository/docker/SxunS/nas-tools

TG频道：https://t.me/nastool

WIKI：https://github.com/SxunS/nas-tools/wiki
...
### 1、Docker
```
docker pull SxunS/nas-tools:latest
```
...
```
git clone -b master https://github.com/SxunS/nas-tools --recurse-submodule 
...
https://github.com/SxunS/nas-tools/releases
